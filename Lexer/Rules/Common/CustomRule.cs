...
{
    private Func<IRuleInput, IEnumerable<IRawLexeme>> _func;
    ...
    public Func<IRuleInput, IEnumerable<IRawLexeme>> Func
    {
        get => _func;
    ...
    public CustomRule(Func<IRuleInput, IEnumerable<IRawLexeme>> func, string type, IRuleSettings ruleSettings) : base(type, ruleSettings)
    {
        Func = func;
    }
    ...
    /// <param name="func">The function that defines how to find lexemes.</param>
    /// <exception cref="ArgumentNullException">Thrown when a null func or ruleSettings is passed to the constructor.</exception>
    public CustomRule(Func<IRuleInput, IEnumerable<IRawLexeme>> func, string type) : this(func, type, new CommonRuleSettings()) { }
    ...
    public override IEnumerable<IRawLexeme> FindLexemes(IRuleInput input) => Func(input);
}
